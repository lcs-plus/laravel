                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            @foreach($user as $v)
                                <tr class="gradeX">
                                    ...
                                    <td>{{ $v->update_time}}</td>
                                    <td>
                                        <a type="button" href="{{ URL::asset('menu/menu/index/'.$v->id) }}"
                                           class="btn btn-outline btn-success">编辑</a>
                                        <a type="button" data-id="{{ $v->id }}"
                                           class="btn btn-outline btn-info remove_this">删除</a>
                                    </td>
                                </tr>
                            @endforeach
